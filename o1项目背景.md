...
**评测对比（2024年7月 Uncheatable Eval）**：

| 对比对象 | 结果 |
|:--------|:----|
| vs Llama 2 13B | RWKV胜，英语相当，多语言显著领先 |
| vs Qwen1.5 14B | RWKV胜，综合评分更高 |
| vs Mistral 12B | Mistral胜（训练数据量是RWKV的好几倍）|

- 在 Uncheatable Eval 排名中排第2
- 支持100+语言
